...
const Footer = () => {
  return (
    <footer className="py-16 px-4 md:px-8 lg:px-16 xl:px-32 border-t border-gray-800 bg-black text-white text-center sm:text-start">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          {/* About Us */}
          <div className="md:col-span-5 lg:col-span-6">
             <img src="/logo2.png" alt="Axiom Logo" className="h-10 w-auto mx-auto sm:mx-0 mb-4" />
            <p className="text-gray-400 max-w-md">
                Intelligent. Integrated. Compliant. Suronex unifies your multi-cloud assets, detects what matters and automate the work that slows you down.
            </p>
          </div>

          {/* Useful Links */}
          <div className="md:col-span-3 lg:col-span-3">
            <h4 className="text-lg font-semibold mb-4 text-pink-500">Useful Links</h4>
          ...
          <div className="md:col-span-4 lg:col-span-3">
            <h4 className="text-lg font-semibold mb-4 text-pink-600">Connect With Us</h4>
        ...
        <div className="mt-16 border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-center items-center text-gray-500">
